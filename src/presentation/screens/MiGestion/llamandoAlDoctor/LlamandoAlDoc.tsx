...
export const LlamandoAlDoc = () => {
  console.log('Entrando al LlamandoAlDoc---->')
 ...
 //--------------------- LOGICA PARA OBTENER LOS DATOS RESTANTES QUE VAMOS A MANDAR EN EL BODY-------------------------------------->

useEffect(() => {
  
  const obtenerDatos = async () => {

    const { dni, idAfiliadoTitular } = await useAuthStore.getState(); // Obtener el estado actual del store
    console.log('dni de Afiliado:', dni);
    console.log('ID de Afiliado Titular:', idAfiliadoTitular);
 ...
 /* {
  ...
  "email": "gonzalomorresi@ejemplo.com",
  "name": "gonzalo Morresi",
       ...
       {/*  <Divider  marginTopDivider={MarginTopDivider} /> */}
        ...
        <View style={{ alignSelf: 'center', marginTop:hp('1%')/* marginTop: 5, */ /* backgroundColor:'yellow', marginTop:hp('1%') */}}>
          ...
          <TertiaryButton
            ...
            label="Comunicarme con un Médico"
